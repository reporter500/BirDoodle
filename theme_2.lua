...
local Theme =
	...
	WindowCaptionColor1        = {20,40,20}   , -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {240,250,240}, -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {50,50,50},    -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {50,50,50},    -- COLOR OF BUTTON TEXT CAPTIONS
	EmbossColorHigh            = {255,255,255}, -- USED FOR EMBOSSED THINGS LIKE BORDERS, LABEL ETC.
	EmbossColorLow             = {0,0,0},       -- USED FOR EMBOSSED THINGS LIKE BORDERS, LABEL ETC.
	BubbleTextColor            = {0,0,0},       -- COLOR OF A WIDGET'S BUBBLE TEXT (SLIDERS, DRAG BUTTON ETC., WHILE BEING DRAGGED)
	SliderTickStrokeColor      = {100,100,100}, -- SLIDER TICKS OUTLINE COLOR
	SliderTickFillColor        = {150,150,150}, -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {0,0,0},       -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	...
	InputTextColor             = {0,0,0},       -- INPUT TEXT COLOR
