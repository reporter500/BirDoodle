...
local Theme =
	...
	--------------------------------------------------------
	SwitchOnColor              = {255,255,255}, -- OPTIONAL COLOR OF ON/OFF SWITCHES WHEN SWITCH IS "ON"
	WindowCaptionColor1        = {200,210,200}   , -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {20,40,20}, -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {250,250,250}, -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {250,250,250}, -- COLOR OF BUTTON TEXT CAPTIONS
	EmbossColorHigh            = {185,195,185}, -- USED FOR EMBOSSED THINGS LIKE BORDERS, LABEL ETC.
	EmbossColorLow             = {0,0,0},       -- USED FOR EMBOSSED THINGS LIKE BORDERS, LABEL ETC.
	BubbleTextColor            = {245,255,245}, -- COLOR OF A WIDGET'S BUBBLE TEXT (SLIDERS, DRAG BUTTON ETC., WHILE BEING DRAGGED)
	SliderTickStrokeColor      = {0,0,0},       -- SLIDER TICKS OUTLINE COLOR
	SliderTickFillColor        = {200,225,225}, -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {245,255,245}, -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	ListItemSelectedGradient   = graphics.newGradient({255,175,50,125},{155,50,0,125}, "top" ),   -- SELECTED LIST ITEM BACKGROUND COLOR GRADIENT
